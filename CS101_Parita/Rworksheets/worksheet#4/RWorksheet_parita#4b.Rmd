...
```{r}
alexa_df <- read.csv("alexa_file.xlsx")

alexa_df$variation <- trimws(alexa_df$variation)

alexa_df$variation <- gsub(" +", " ", alexa_df$variation)

alexa_df$variation <- gsub(" ", "", alexa_df$variation)

cat("\n--- Unique Variations AFTER Cleaning and Renaming ---\n")
print(sort(unique(alexa_df$variation)))
```
